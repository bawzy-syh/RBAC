...
public class CodeGenerator {
    ...
    static {
        ...
        try {
            //properties.load(i);
            projectPackage = "org.syh.RBAC";
            controllerPackage = "controller";
            entityPackage = "model";
            url = "jdbc:mysql://127.0.0.1:3306/rbac?useSSL=false&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull";
            username = "root";
            password = "root";
    ...
    public static void main(String[] args) {
        ...
        strategy.setInclude("user_role_relation");
